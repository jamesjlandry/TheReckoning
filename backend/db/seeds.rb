...
CurseLevel.create(name: "Bitter Cold", level: 1, blessing_id: 1, text: "Whenever you use at least 1 point of Magic, every creature adjacent to you, including yourself, takes 1 point of damage from a sudden drop in temperature. This effect lasts 1 round.")
...
CurseLevel.create(name: "Tangible Air", level: 1, blessing_id: 2, text: "Whenever you use at least 1 point from your Magic pool, every creature adjacent to you, including yourself, is slowed for 1 round. While slowed, you can only move or take an action, but not both.")
...
Weapon.create(name: "Hand Cannon", style: "Light", damage: 4, text: "A new invention to the world, Hand Cannons fire a single round bullet that are not always accurate even at short range. Hand Cannons ignore non-magical armor, however you suffer -1 to your attacks. Comes with 12 bullets. Short Range.", cost: 12)
...
Skill.create(name: "Craft", text: "Choose a specific type of mundane item, such as tailoring, metalwork, or woodworking. You are trained in crafting items of that type.")
